    ...
    <section id="faqs" className="max-w-7xl sm:px-6 mx-auto px-4 py-8 sm:py-12">
      <div className="relative overflow-hidden rounded-[32px] glass-ultra glass-glow p-6 sm:p-10">
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 relative z-10">
          ...
          <FAQItem q="How will I receive my guide after payment?" a={<span>Once your £29 payment is confirmed, you'll be redirected to a secure download page and receive an email with your files. You can save them on your device and re-download anytime — instant access, no waiting.</span>} />
