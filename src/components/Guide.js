      ...
      <div className="relative overflow-hidden rounded-[32px] border border-neutral-200 bg-white shadow-[0px_0px_0px_1px_rgba(0,0,0,0.04),0px_20px_40px_-20px_rgba(0,0,0,0.18)]">
        ...
        <div className="relative p-6 sm:p-10">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-medium tracking-tighter text-neutral-950 font-geist">The Complete UK Guide to Airbnb Hosting</h2>
            <p className="mt-2 text-neutral-600 text-base sm:text-lg font-geist">A step‑by‑step playbook to launch, run and optimise a compliant, profitable short‑let in the UK. Includes templates, checklists and pricing frameworks.</p>
          </div>

          <div className="mt-8">
            {/* Single product card */}
            <div className="group rounded-2xl border border-neutral-200 bg-white p-6 ring-1 ring-transparent hover:ring-neutral-900/10 transition">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                {/* Guide summary */}
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xl font-semibold font-geist tracking-tight text-neutral-900">Instant Download</h3>
                    <span className="text-xs font-medium text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-full px-2.5 py-1">PDF • 120+ pages</span>
                  </div>
                ...
                <div className="w-full lg:w-[320px] shrink-0">
                  <div className="rounded-xl border border-neutral-200 bg-neutral-50/60 hover:bg-white transition-colors p-5">
                    ...
                    <div className="mt-4 flex flex-col gap-2">
                      ...
                      <a href="#" className="inline-flex items-center justify-center gap-2 rounded-full bg-white hover:bg-neutral-50 border border-neutral-200 text-neutral-900 text-sm font-medium px-4 py-2 transition-colors">
                        Download sample (TOC)
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 -mr-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 3v12"></path><path d="m7 10 5 5 5-5"></path><path d="M5 19h14"></path></svg>
                      </a>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              <a href="#" className="inline-flex items-center gap-2 rounded-full bg-white hover:bg-neutral-50 border border-neutral-200 text-neutral-900 text-sm font-medium px-4 py-2 transition">
                See full table of contents
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 -mr-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 7h13"></path><path d="M3 12h13"></path><path d="M3 17h7"></path><path d="M17 3v18"></path></svg>
              </a>
